  ...
  return (
    <div className="max-w-3xl mx-auto py-8 px-4 lg:py-12 min-h-screen flex flex-col gap-12">
      ...
      <main className="flex-1 flex flex-col gap-6 lg:gap-8">
        <p>For years, I was just an average student. Not bad, not great. Without putting in much effort, I consistently scored around 11 or 12 out of 20 throughout middle school and high school. I was coasting. But everything changed once I got to university. I started playing the game differently. Not by working harder than everyone else &mdash; but by working smarter. And without cheating, without burning out, I ended up in the top 10% of my class. Here are the 3 simple techniques &mdash; almost like glitches in the system &mdash; that helped me do it.</p>

        <h2 className="text-xl font-bold mt-6">1. Study the Class Before the Class</h2>
        <p>Most professors reuse their lectures every year. Same slides, same examples, same explanations &mdash; sometimes even the exact same wording.</p>
        <p>So my first tactic was simple: get ahead. I got hold of notes from a student who had already taken the same classes the year before. Before each lecture, I would skim through the upcoming chapter. Five to ten minutes the night before &mdash; that&apos;s all it took.</p>
        <p>Once I was in class, everything felt familiar. The professor&apos;s explanations sounded like d&eacute;j&agrave; vu. I could predict what was coming next. When they asked questions, I already had answers &mdash; not because I was a genius, but because I had seen it before. That made class participation feel natural, and my understanding much deeper. Some might call it cheating &mdash; but to me, it&apos;s just being prepared.</p>

        <h2 className="text-xl font-bold mt-6">2. Past Exams Are a Cheat Code</h2>
        <p>Just like lectures, exams don&apos;t change much from year to year. Once I realized that, I started collecting previous years&rsquo; exams &mdash; sometimes even with answer keys or graded copies.</p>
        ...
        <p>So before finals, I&apos;d train with old exams. Not only was it the best prep &mdash; it also removed most of the surprise and stress. It was like rehearsing before a performance. And when the real show came, I was ready.</p>

        <h2 className="text-xl font-bold mt-6">3. Learn by Teaching: Smart Group Work</h2>
        <p>This last strategy is powerful &mdash; and completely underrated: learn by teaching.</p>
