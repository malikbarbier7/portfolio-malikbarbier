  ...
  return (
    <div className="max-w-3xl mx-auto py-8 px-4 lg:py-12 min-h-screen flex flex-col gap-12">
      ...
      <main className="flex-1 flex flex-col gap-6 lg:gap-8"> 
        ...
        <Image src="/img/article2/mouse_black_and_white_drawing__mouse_in_front_of_a_big_labyrinth.png" alt="mouse" className="w-2/5 h-auto mx-auto" width={500} height={300} />
        ...
        <Image src="/img/article2/human_consciousness.png" alt="human consciousness" className="w-2/5 h-auto mx-auto" width={500} height={300} />
